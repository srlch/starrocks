...
public class DictionaryMgrInfo implements Writable {
    ...
    @SerializedName(value = "lastSuccessTxnId")
    private long lastSuccessTxnId = -1L;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof DictionaryMgrInfo)) {
            return false;
        }

        DictionaryMgrInfo info = (DictionaryMgrInfo) obj;

        return (this.nextTxnId == info.getNextTxnId() &&
                this.nextDictionaryId == info.getNextDictionaryId());
    }
