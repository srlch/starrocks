...
public class DictionaryCacheSink extends DataSink {
    ...
    public String getExplainString(String prefix, TExplainLevel explainLevel) {
        ...
        sb.append(prefix + "DICTIONARY CACHE SINK\n");
        sb.append(prefix + "DICTIONARY ID: " + this.dictionary.getDictionaryId());
        sb.append(prefix + "Be Nodes:\n");
        for (TNetworkAddress node : nodes) {
            sb.append(prefix + "hostname: " + node.getHostname() +
                      " port: " + node.getPort() + "\n");
        }
        return sb.toString();
    }
