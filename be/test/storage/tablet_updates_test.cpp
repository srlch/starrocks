...
void TabletUpdatesTest::test_get_column_values(bool enable_persistent_index) {
    ...
    tablet->updates()->get_column_values(read_column_ids, 0, rowids_by_rssid, &read_columns, nullptr);
    ...
    tablet->updates()->get_column_values(read_column_ids, 1, rowids_by_rssid, &read_columns. nullptr);
