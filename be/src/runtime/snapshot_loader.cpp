...
bool SnapshotLoader::_is_index_files(const std::string& str) {
    return _end_with(str, "fdt") || _end_with(str, "fdx") || _end_with(str, "fnm") ||
           _end_with(str, "frq") || _end_with(str, "nrm") || _end_with(str, "prx") ||
           _end_with(str, "tii") || _end_with(str, "tis") || _end_with(str, "null_bitmap") ||
           _end_with(str, "segments_2") || _end_with(str, "segments.gen");
}
